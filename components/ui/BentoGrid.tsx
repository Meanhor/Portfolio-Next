    ...
    >
      <div className={`${id === 6 && 'flex justify-center' } h-full`}>
        ...
        {id === 6 && (
          <BackgroundGradientAnimation>
            ...
            justify-center text-white font-bold px-4 pointer-events-none 
      ...
      >
        ...
        <div className="font-sans font-bold text-lg lg:text-3xl max-w-96 z-10">
          ...
          {id === 3 && (
            <div className="flex flex-col gap-3 lg:gap-8 absolute top-10 right-0">
              {['VueJS.js', 'AWS', 'MangoDB'].map((item) => (
